...
#define CSN       PC_ODR_bit.ODR4           // Chip enable pin, (output to CSN, nRF24L01)
...
#define SCK       PC_ODR_bit.ODR6           // Serial Clock pin, (output)
#define RELAY_1   PB_ODR_bit.ODR4           // Relay 1 
#define RELAY_2   PB_ODR_bit.ODR5           // Relay 2
#define LED       PD_ODR_bit.ODR3           // LED
...
#define RX_DR  (status & 0x40)
#define TX_DS  (status & 0x20)
#define MAX_RT (status & 0x10)
