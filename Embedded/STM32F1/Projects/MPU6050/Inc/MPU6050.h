...
#define RATE_8KHz       0x00   /*!< Sample rate set to 8 kHz */
#define RATE_4KHz       0x01   /*!< Sample rate set to 4 kHz */
#define RATE_2KHz       0x03   /*!< Sample rate set to 2 kHz */
#define RATE_1KHz       0x07   /*!< Sample rate set to 1 kHz */
#define RATE_500Hz      0x0F  /*!< Sample rate set to 500 Hz */
#define RATE_250Hz      0x1F  /*!< Sample rate set to 250 Hz */
#define RATE_125Hz      3F  /*!< Sample rate set to 125 Hz */
#define RATE_100Hz      4F  /*!< Sample rate set to 100 Hz */
